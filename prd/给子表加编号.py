...
def test():
    excel_file = 'E:\\01--高星--\\01 工作文档\\待办\\车辆销售数据\\新建文件夹\\CAP-ZCXS-02 新车销售单_6.xls' # 待处理
    headNum1 = 3 #主表的表头行数
    headNum2 = 2 #子表的表头行数
    ...
    try:
        ...
        for i in range(1,len(xls.sheets)):
            ...
            for y in range(headNum2 + 1, nrows2 + 1):
                print("索引为",i,"的表","写入第",y,"行数据的key为",currentSubSheet.range(y, subJiaIdColm).value)
