...
def start():
    ...
    global xPositon
    global yPositon
    excel_file = 'E:\\01--高星--\\01 工作文档\\03 超30天未报销事项\\20210408\\超30未报销查询.xlsx'  # 数据源
    out_file_path = 'E:\\01--高星--\\01 工作文档\\03 超30天未报销事项\\20210408\\待处理\\'         #处理后文件地址
    keyword = '单位'                                                                             #以此关键字划分文件
    addFileName = '超30天未报销事项查询_需反馈'
    addKeyWord = ['是否已报','未报原因','是否原因不明','备注']
    bgColor = [255, 255, 0]
    font = 'Calibri'
    blod = True
    headNum = 2
